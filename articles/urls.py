...
urlpatterns = [
    ...
    path("comment/<int:pk>/", require_POST(views.ArticleCommentView.as_view()), name="comment"),
    path("sub_comment/<int:pk>/", require_POST(views.ArticleSubCommentView.as_view()), name="sub_comment"),
    path(
        "<int:pk>/<slug:slug>/",
